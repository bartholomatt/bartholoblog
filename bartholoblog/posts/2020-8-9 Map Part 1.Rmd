---
title: "2020-8-3 Crowded Housing"
...
One of the many perks of having Data Science skills is being able to interact with statistics and graphs that you see in the news in a much deeper way. This weekend's New York Times <a href = 'https://www.nytimes.com/2020/08/01/business/economy/housing-overcrowding-coronavirus.html'> included </a> a really interesting graphic on housing density and overcrowding in the Bay Area: 
...
Now we've got a dataframe with one row for each census tract that contains a shapefile for the contours of the tract, plus a calculation of the percentage of housing units that have more than one occupant per room. We'll cover making the map using ggplot in part 2.
